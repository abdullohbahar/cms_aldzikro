                ...
                <table class="min-w-full">
                    <thead>
                        <tr class="border-b border-gray-100">
                            ...
                            <th class="text-left text-xs font-medium text-gray-500 uppercase tracking-wider py-2">Status
                            </th>
                            ...
                            <tr>
                                <td class="py-3 text-sm">
                                    <div class="flex items-center">
                                        ...
                                        @endif
                                        <span
                                            class="font-medium text-gray-900 truncate max-w-xs">{{ $article->title }}</span>
                                    </div>
                                </td>
                                <td class="py-3 text-sm">
