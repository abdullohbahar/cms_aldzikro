        ...
        <form action="{{ route('admin.articles.update', $article) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <textarea name="content" id="content" rows="10" 
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('content', $article->content) }}</textarea>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="flex items-center justify-center w-full">
                    <label for="image-upload" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 overflow-hidden relative">
                        ...
                        <div class="flex flex-col items-center justify-center pt-5 pb-6 {{ $article->image_path ? 'hidden' : '' }}" id="upload-placeholder">
                        ...
                        <img id="image-preview" src="{{ $article->image_path ? asset('storage/' . $article->image_path) : '' }}" class="absolute inset-0 w-full h-full object-cover {{ $article->image_path ? '' : 'hidden' }}">
            ...
            <div class="flex gap-3">
                ...
                <a href="{{ route('admin.articles.index') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-6 py-2 rounded-lg">
                    Batal
                </a>
            </div>
        </form>
