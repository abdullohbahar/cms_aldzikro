                ...
                <div class="mb-6">
                    ...
                    <div class="flex items-center justify-center w-full">
                        <label for="image-upload"
                            ...
                            <div class="flex flex-col items-center justify-center pt-5 pb-6 {{ $article->image_path ? 'hidden' : '' }}"
                                id="upload-placeholder">
                                <i class="fas fa-cloud-upload-alt text-4xl text-gray-400 mb-3"></i>
                                <p class="mb-2 text-sm text-gray-500"><span class="font-semibold">Klik untuk ganti</span>
                            ...
                            <img id="image-preview"
                                ...
                                class="absolute inset-0 w-full h-full object-cover {{ $article->image_path ? '' : 'hidden' }}">
