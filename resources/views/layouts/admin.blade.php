    ...
    <div class="min-h-screen flex flex-col md:flex-row">
        ...
        <aside id="sidebar" class="sidebar bg-gray-900 text-white w-64 flex-shrink-0 min-h-screen md:block hidden">
            ...
            <nav class="mt-6 px-4">
                ...
                <a href="{{ route('admin.testimonials.index') }}" class="flex items-center px-4 py-3 mb-2 rounded-lg hover:bg-gray-800 transition {{ request()->routeIs('admin.testimonials.*') ? 'bg-blue-600 text-white shadow-lg' : 'text-gray-300' }}">
                    <i class="fas fa-quote-right w-6 text-center mr-2"></i>
                    <span class="font-medium">Testimoni</span>
                </a>

                <a href="{{ route('admin.board-members.index') }}" class="flex items-center px-4 py-3 mb-2 rounded-lg hover:bg-gray-800 transition {{ request()->routeIs('admin.board-members.*') ? 'bg-blue-600 text-white shadow-lg' : 'text-gray-300' }}">
