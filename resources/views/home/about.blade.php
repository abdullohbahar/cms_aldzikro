            ...
            <div class="grid grid-cols-3 gap-5 md:gap-8">
                <div class="col-span-3 md:col-span-1">
                    <div class="text-center">
                        ...
                        <img src="{{ asset('/assets/icons/lamp.svg') }}" alt=""
                            class="size-12 object-contain mx-auto mb-3">
                        <h3 class="text-lg text-primary font-semibold mb-4">Awal Berdiri</h3>
                        <p class="text-secondary text-base/7">Yayasan Al-Dzikro berawal pada tahun <span
                                class="font-bold">1993</span>, terinspirasi dari kisah dua anak kecil yang kehilangan kedua
                            orang tuanya.</p>
                    </div>
                </div>
                ...
                <div class="col-span-3 md:col-span-1">
                    <div class="text-center">
                        ...
                        <img src="{{ asset('/assets/icons/hand.svg') }}" alt=""
                            class="size-12 object-contain mx-auto mb-3">
                        <h3 class="text-lg text-primary font-semibold mb-4">Membentuk Yayasan</h3>
                        <p class="text-secondary text-base/7">Kepedulian masyarakat menguatkan langkah untuk membentuk
                            yayasan resmi pada <span class="font-bold">8 Oktober 1997</span>.</p>
                    </div>
                </div>
                ...
                <div class="col-span-3 md:col-span-1">
                    <div class="text-center">
                        ...
                        <img src="{{ asset('/assets/icons/building.svg') }}" alt=""
                            class="size-12 object-contain mx-auto mb-3">
                        <h3 class="text-lg text-primary font-semibold mb-4">Berkembang</h3>
                        <p class="text-secondary text-base/7">Dengan dukungan donatur, pada <span
                                class="font-bold">2005</span> diperoleh tanah wakaf 1.359 m² yang menjadi pusat kegiatan dan
                            pembangunan fasilitas yayasan.</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-span-12 md:col-span-6">
                            <div class="grid grid-cols-12">
                                @if ($index % 2 == 0)
                                    ...
                                    <div class="col-span-12 lg:col-span-6">
                                        <img src="{{ asset('storage/' . $facility->image_path) }}"
                                            alt="{{ $facility->name }}" class="w-full h-60 object-cover object-bottom">
                                    </div>
                                    <div
                                ...
                                @else
                                    ...
                                    <div class="col-span-12 lg:col-span-6">
                                        <img src="{{ asset('storage/' . $facility->image_path) }}"
                                            alt="{{ $facility->name }}" class="w-full h-60 object-cover object-center">
                                    </div>
                                @endif
                            </div>
                        </div>
            ...
            <div class="grid grid-cols-2 gap-4 md:gap-15 items-center">
                <div class="col-span-2 md:col-span-1">
                    <iframe
                        ...
                        class="w-full h-80" allowfullscreen="" loading="lazy"
                        referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
                <div class="col-span-2 md:col-span-1">
                    <h2 class="section-title mb-7">Lokasi Yayasan Al-Dzikro</h2>
                    <p class="section-description font-bold">Pedukuhan Manggung RT 07, Desa Wukirsari, Imogiri, Bantul,
                        Yogyakarta</p>
                    <p class="section-description">Dekat dengan sekolah MTs N Giriloyo, SMAN 1 Imogiri, dan pesantren
                        sekitar.</p>
                </div>
            </div>
        </div>
